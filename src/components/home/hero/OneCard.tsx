...
const OneCard = () => {
    ...
    console.log(cardDetails.item.desc[0].para1)
  ...
  return (
    <>
      ...
      <div className="par1">
        <img src={cardDetails.item.cover} alt="News" className="news-card__image" />
      </div>
      ...
      <div className="par2">
        ...
        <div className="par22">
          <div className="sentiment">
            <SentimentChart description={cardDetails.item.desc[0].para1+cardDetails.item.desc[1].para2+cardDetails.item.desc[2].para3}/>
          </div>
